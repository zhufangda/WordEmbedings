...
public class Main implements MainConstants {
        ...
        if(args.length ==3 && args[1].equals("-k")){
            ...
            size = 7;
                ...
                System.out.println("Entrer un mot, notre application va imprimier"
                            ...
                            + "d'apr\u00c3\u00a8s la mesure de similarit\u00c3\u00a9 cosinus."
                            + "\u005cnVous pouvez aussi entrer un expression arithm\u00c3\u00a9tique."
                            + "\u005cnFor example,Londres + (France - Paris).");
  ...
  static final public void parseOneLine() throws ParseException, WordNotFoundException {
    Vector a;
    ...
    if (jj_2_1(2)) {
      ...
      for (Entry<Double, String> entry : resultat) {
        System.out.println("\u005ct" + entry.getKey() + "\u005ct" + entry.getValue());
        output.append("\u005ct" + entry.getKey() + "\u005ct" + entry.getValue() + "\u005cn");
    }
  ...
  static final public Vector expr() throws ParseException, WordNotFoundException {
    Vector a;
    Vector b;
    a = unary();
    label_1:
  ...
  static final public Vector unary() throws ParseException, WordNotFoundException {
    Vector a;
    if (jj_2_7(2)) {
      jj_consume_token(8);
      a = element();
                         {if (true) return a.multiplication(-1);}
    } else if (jj_2_8(2)) {
      a = element();
                         {if (true) return a;}
    } else {
  ...
  static final public Vector element() throws ParseException, WordNotFoundException {
    Token t;
    Vector a;
    if (jj_2_9(2)) {
      ...
      {if (true) return corpus.getVector(t.toString());}
    } else if (jj_2_10(2)) {
      jj_consume_token(9);
      a = expr();
      jj_consume_token(10);
